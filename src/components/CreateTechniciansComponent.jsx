...
class CreateTechniciansComponent extends Component {
      constructor(props){
          super(props)
              this.state ={
...
export default CreateTechniciansComponent;
 ...
 /*
  ...
  if( this.state.fullName.length < 2)   
  {
   ...
   if( ! this.state.emailID.includes('@'))    
    {
        this.setState({
                        emailIdError:' x Invalid Email Address !'
                        
                     });
    }

    if(this.state.phoneNumber.length < 10 ||  this.state.phoneNumber.match(letters) || this.state.phoneNumber.match(specialCharacters))
    {
        this.setState({
                         phonenumberError:' x Invalid Phone Number !'
  ...
  if( this.state.Gender.length < 1 )   
  {
      this.setState({
                     ...
                     genderError:"Invalid Gender : Cannot be empty !"

                      
                   });
  }

   if(! this.state.permanentaddress.includes(','))   
  {
      this.setState({
                      permanentAddressError:' x Invalid Address !'
   ...
   if( this.state.password.length < 5)   
    {
        this.setState({
                        passwordError:' x Invalid Password !'
                        
                     });
    }
   
    if(! this.state.communicationAddress.includes(','))   
    {
        this.setState({
                        communicationaddressError:' x Invalid Address !'
